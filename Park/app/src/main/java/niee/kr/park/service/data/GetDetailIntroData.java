 ...
 */
public class GetDetailIntroData extends AsyncTask<String,String,String>{
    ...
    public GetDetailIntroData(Activity activity){
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        progressActivity.show("상세 정보를 가져오는 중입니다");
    }
    ...
    protected void onPostExecute(String result) {
        ...
        ((FullscreenActivity)activity).setDetailIntro(result);
...
//        음식점 : 39
        ...
        String sUrl = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailIntro?ServiceKey="+ APIKey.API_KEY_DATA_INFO+"&contentId="+contentId+"&contentTypeId="+contentTypeId+"&MobileOS=AND&MobileApp="+APIKey.API_KEY_APP_NAME;
        return sUrl;
    }
