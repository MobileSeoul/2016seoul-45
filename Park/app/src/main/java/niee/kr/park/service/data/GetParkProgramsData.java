 ...
 */
public class GetParkProgramsData extends AsyncTask<String,String,String>{
    ...
    public GetParkProgramsData(Activity activity){
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        progressActivity.show("프로그램 리스트를 가져오는 중입니다");
    }

    @Override
    protected void onPostExecute(String result) {
        ((FullscreenActivity)activity).setParkProgramList(result);
    ...
    protected String doInBackground(String... strings) {
        ...
        String tempStr = "";
        try {
            url = new URL("http://openapi.seoul.go.kr:8088/"+ APIKey.API_KEY_PARK_INFO+"/json/SearchProgramsByParkIDService/1/50/"+parkId);
